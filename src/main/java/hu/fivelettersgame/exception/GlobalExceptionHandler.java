...
package hu.fivelettersgame.exception;
...
//        logger.error("Username duplicate error: ", ex);
//        HttpStatus status = HttpStatus.BAD_REQUEST;
//
//        ApiError body = new ApiError("ILLEGAL_ARGUMENT_ERROR", "An illegal argument has been passed to the method.", ex.getLocalizedMessage());
//
...
//        logger.error("Error occurred during file reading:", ex);
//        HttpStatus status = HttpStatus.BAD_REQUEST;
//
//        ApiError body = new ApiError("IO_EXCEPTION", "Error during file operations", ex.getLocalizedMessage());
//
//        return new ResponseEntity<>(body, status);
//    }
